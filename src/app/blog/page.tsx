...
const Page = async () => {
  ...
  return (
    <main className="flex flex-col min-h-screen items-center justify-center">
      <div className="flex flex-col gap-[10px] justify-center items-center max-[450px]:w-full max-[450px]:max-w-[360px] max-w-[1096px] w-[1096px] min-h-screen p-24">
        <div className="flex items-center justify-between w-[1096px] max-[450px]:w-[360px] -z-10">
          <p className="font-medium text-black text-[12px]">Essaymate Blog</p>
        </div>
        <div className="flex items-center justify-between w-[1096px] max-[450px]:w-[360px] -z-10">
          <p className="font-bold text-black text-[50px] max-[450px]:text-[30px] w-[775px] max-[450px]:w-[360px]">
            Check out the latest insights on Dash and AI at work
          </p>
        </div>
        <div className="flex items-center justify-between max-[450px]:justify-center w-[1096px] max-[450px]:w-[360px] mt-10">
          <Icons.Line />
        </div>
            ...
            {latestPost && (
              <div className="flex flex-col gap-5 items-center justify-center w-[366px] h-[278px] mt-10">
                ...
                <Link
                  ...
                  className="mr-auto hover:border-b hover:border-b-black transition duration-200 w-[62px] h-5 mt-5"
                >
                  <p className="font-medium text-[12px] text-black mr-auto cursor-pointer">
                    Read More
                  </p>
                </Link>
              </div>
        ...
        <div className="md:grid md:grid-cols-3 max-[450px]:flex max-[450px]:flex-col items-center justify-center w-[1096px] max-[450px]:w-[360px] mt-[90px] gap-[50px]">
          {posts.map((post) => (
            <div
              key={post.id}
              className="flex flex-col max-[450px]:items-center max-[450px]:justify-center gap-2.5 w-[332px] h-[400px]"
            >
              <div className="w-[332px] h-[198px] rounded-[20px] bg-gray-500 max-[450px]:items-center max-[450px]:flex max-[450px]:justify-center"></div>
              <div className="w-[332px] h-[182px] flex flex-col gap-2.5 items-center justify-center mr-auto">
                ...
                <Link
                  href={`/blog/${post.id}`}
                  className="font-medium text-[12px] text-black mt-5 mr-auto cursor-pointer hover:border-b hover:border-b-black transition duration-200 w-[62px] h-5"
                >
                  Read More
                </Link>
              </div>
