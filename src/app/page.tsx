...
import gradientBlur from "../../public/Gradient_Blur.svg";
  ...
  return (
    <main className="flex flex-col min-h-screen items-center justify-center bg-[url('../../public/Dot.svg')] overflow-hidden">
      <div className="flex flex-col gap-[21px] justify-center items-center max-[450px]:w-full max-[450px]:max-w-[450px] max-w-[1440px] min-h-screen p-24 mb-10 -mt-20 max-[450px]:-mt-40">
          ...
          <div className="flex flex-col w-[628px] h-[598px] max-[450px]:w-[360px] max-[450px]:items-center max-[450px]:justify-center gap-2.5 -z-10">
            ...
            <div className="flex flex-col w-[628px] max-[450px]:w-[360px] ">
              <p className="font-geist font-semibold text-[56px] text-black max-[450px]:w-[360px] max-[450px]:text-center max-[450px]:text-[46px]">
                AI Essay Writer: <br className={"max-[450px]:hidden"} />
                <span
                  className={"bg-purple-gradient text-transparent bg-clip-text"}
                >
                  Write 5x Faster Essays
                </span>
                <br className={"max-[450px]:hidden"} /> Without Plagiarism
              </p>
            </div>
        ...
        <div className="absolute mr-[1068px] -mt-[3834px] -z-10 max-[450px]:hidden">
          <Icons.Union />
        </div>
        <div className="absolute mr-[1068px] -mt-[1090px] -z-10 max-[450px]:hidden">
          <Icons.Union />
        </div>
        <div className="absolute translate-x-[540px] -mt-[2454px] -z-10 max-[450px]:hidden">
          <Icons.Union />
        </div>
        <div className="absolute -ml-[423px] mt-[730px] z-0 max-[450px]:hidden">
          <Icons.Union />
        </div>
        <div className="absolute ml-[500px] mt-[1420px] z-0 max-[450px]:hidden">
          <Icons.Union />
        </div>
        <div className="flex flex-row items-center justify-center w-[1320px] h-[650px] max-[450px]:w-[358px] max-[450px]:h-[482px] bg-white rounded-3xl border border-[#6386FF33] drop-shadow-[0_10px_30px_0_rgba(0,0,0,0.1)] shadow-[0_7px_3px_0_rgba(0,0,0,0.06)]">
          ...
          <div className="flex flex-col w-[462px] items-center justify-center xl:mr-auto xl:-translate-x-[174px] gap-2.5">
        ...
        <div className="flex flex-row max-[450px]:flex-col mt-[9px] gap-[30px] items-center justify-center w-[1320px] max-[450px]:w-[358px]">
          <div className="flex flex-col items-center justify-center w-[645px] h-[650px] max-[450px]:w-[358px] max-[450px]:h-[386px] rounded-3xl bg-white border border-[#6386FF33] drop-shadow-[0_10px_30px_rgba(0,0,0,0.1)] shadow-[0_7px_3px_0_rgba(0,0,0,0.06)]">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex flex-row items-center justify-center z-10 gap-[5px] mr-[16px] rotate-180 -mt-[14px] max-[450px]:hidden">
                <div className="mt-[46px]">
                  <Icons.ThinArrow />
                </div>
          ...
          <div className="flex flex-col items-center justify-center w-[645px] h-[650px] max-[450px]:w-[358px] max-[450px]:h-[408px] rounded-3xl bg-white border border-[#6386FF33] drop-shadow-[0_10px_30px_rgba(0,0,0,0.1)] shadow-[0_7px_3px_0_rgba(0,0,0,0.06)]">
            <div className="flex absolute items-center justify-center max-[450px]:hidden">
              <Icons.SmallDot />
            </div>
            <div className="flex items-center justify-center w-[295px] h-[100px] rounded-[20px] border border-[#6386FF33] translate-y-[42px] max-[450px]:hidden">
            ...
            <div className="flex flex-row items-center justify-center absolute -translate-x-[5px] z-10 -mt-[180px] max-[450px]:hidden">
        ...
        <div className="flex flex-row justify-center items-center mt-[9px] w-[1320px] h-[650px] max-[450px]:w-[358px] max-[450px]:h-[408px] rounded-3xl bg-white border border-[#6386FF33] drop-shadow-[0_10px_30px_rgba(0,0,0,0.1)] shadow-[0_7px_3px_0_rgba(0,0,0,0.06)] z-10">
        ...
        <div className="flex flex-col justify-center items-center mt-[129px] max-[450px]:mt-[79px] max-[450px]:w-[360px] w-[1320px] gap-[30px]">
          ...
          <div className="flex flex-row gap-[30px] max-[450px]:-mt-[100px] max-[450px]:gap-4 w-[1320px] max-[450px]:w-[390px] max-[450px]:p-24 max-[450px]:pr-20 max-[450px]:overflow-x-scroll items-center justify-center">
            <div className="flex w-[420px] h-[294px] max-[450px]:w-[318px] max-[450px]:h-[318px] max-[450px]:ml-[640px] rounded-3xl p-px bg-gradient-to-b from-[#6386FF33] to-[#6386FF00] drop-shadow-[0_10px_30px_rgba(0,0,0,0.1)] shadow-[0_7px_3px_0_rgba(0,0,0,0.06)]">
              <div className="rounded-[24px] p-12 bg-white">
                <div className="absolute -translate-y-[90px] -rotate-[30deg] max-[450px]:hidden">
                  <Icons.Test1 />
                </div>
                <div className="mt-[40px] flex flex-col h-[66px] w-[322px] max-[450px]:w-[220px] max-[450px]:h-[180px] gap-2.5 items-center justify-center">
            ...
            <div className="flex w-[420px] h-[294px] max-[450px]:w-[318px] max-[450px]:h-[318px] rounded-3xl p-px bg-gradient-to-b from-[#6386FF33] to-[#6386FF00] drop-shadow-[0_10px_30px_rgba(0,0,0,0.1)] shadow-[0_7px_3px_0_rgba(0,0,0,0.06)]">
              <div className="rounded-[24px] p-12 bg-white">
                <div className="mt-[40px] flex flex-col h-[66px] w-[322px] max-[450px]:w-[220px] max-[450px]:h-[180px] gap-2.5 items-center justify-center">
                  <div className="flex items-center justify-center">
                    <Icons.FiveStar />
            ...
            <div className="flex w-[420px] h-[294px] max-[450px]:w-[318px] max-[450px]:h-[318px] rounded-3xl p-px bg-gradient-to-b from-[#6386FF33] to-[#6386FF00] drop-shadow-[0_10px_30px_rgba(0,0,0,0.1)] shadow-[0_7px_3px_0_rgba(0,0,0,0.06)]">
              <div className="rounded-[24px] p-12 bg-white">
                <div className="flex absolute -translate-y-[75px] translate-x-[240px] rotate-[15deg] ml-auto max-[450px]:hidden">
                  <Icons.Test3 />
                </div>
                <div className="mt-[40px] flex flex-col h-[66px] w-[322px] max-[450px]:w-[220px] max-[450px]:h-[180px] gap-2.5 items-center justify-center">
                  <div className="flex items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center gap-[30px] max-w-[840px] mt-[129px] max-[450px]:mt-[79px]">
            ...
            <div className="flex w-[840px] min-h-[1005px] max-[450px]:w-[358px] max-[450px]:min-h-[620px] h-auto rounded-3xl p-px bg-gradient-to-b from-[#6386FF33] to-[#6386FF00] drop-shadow-[0_10px_30px_rgba(0,0,0,0.1)] shadow-[0_7px_3px_0_rgba(0,0,0,0.06)]">
              <div className="rounded-[24px] w-[838px] max-[450px]:w-[356px] bg-white flex items-center justify-center p-[50px]">
                <div className="flex flex-col gap-5 items-center justify-center">
                  {questions.map((item, index) => (
                    <div
                      key={index}
                      className={`flex flex-col justify-between w-[760px] max-[450px]:w-[338px] bg-[#F1F8FB] rounded-[10px] p-5 transition-all duration-500 ${
                        expandedIndex === index
                          ? "h-auto max-[450px]:h-auto"
                          : "h-[65px] max-[450px]:h-auto"
                      }`}
                    >
                      <div
                      ...
                      >
                        <p className="font-geist font-medium text-black text-xl max-[450px]:text-xl max-[450px]:w-[218px]">
                          {item.question}
                        </p>
                        <button
                      ...
                      {expandedIndex === index && (
                        <div className="mt-4">
                          <p className="font-geist text-black text-base">
                            {item.description}
                          </p>
                        </div>
                      )}
