...
function GlobalSearch(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
      ...
      />
      <path
        d="M22 22.75c-.19 0-.38-.07-.53-.22l-1-1a.755.755 0 010-1.06c.29-.29.77-.29 1.06 0l1 1c.29.29.29.77 0 1.06-.15.15-.34.22-.53.22z"
        fill="#2233A8"
      />
    </svg>
  );
...
export default MemoGlobalSearch;
